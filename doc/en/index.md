...
│   ├── tecnico.md
│   ├── I18N.md
│   ├── actividades.md           ← Activity catalogue (Calculia-specific)
│   ├── equipo.md                ← Guide for families / therapists
...
└── en/
    ...
    ├── technical.md
    ├── I18N.md
    ├── activities.md            ← Activity catalogue (Calculia-specific)
    ├── team.md                  ← Guide for families / therapists
...
|---|---|
| Understand what Calculia is and who it is for | [`SPEC.md`](SPEC.md) |
...
| Support an end user (family/therapist) | [`team.md`](team.md) and the public landing page |
